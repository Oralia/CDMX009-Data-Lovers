...
// Funcion que rafica el data para educación
...
function dataBrasil(){
  ...
  document.getElementById("EducacionButton").addEventListener("click", showIndicatorEducacion);
  document.getElementById("graficarEducacion").addEventListener("click",graficarEducacion);
  document.getElementById("EmpleoButton").addEventListener("click", showIndicatorEmpleo);
  document.getElementById("graficarEmpleo").addEventListener("click",graficarEmpleo);
  document.getElementById("NegociosButton").addEventListener("click", showIndicatorNegocios);
  document.getElementById("graficarNegocios").addEventListener("click",graficarNegocios);
  document.getElementById("PoblaciónButton").addEventListener("click", showIndicatorPoblacion );
  document.getElementById("graficarPoblacion").addEventListener("click",graficarPoblacion );
  document.getElementById("SaludButton").addEventListener("click", showIndicatorSalud  );
  document.getElementById("graficarSalud").addEventListener("click",graficarSalud );
  document.getElementById("ViolenciaButton").addEventListener("click", showIndicatorViolencia  );
  document.getElementById("graficarViolencia").addEventListener("click",graficarViolencia );
