...
function educación(countryData) {
  ...
  newdataEducacion = countryData.indicators.filter((indicators) => {
    return (
      indicators.indicatorName.includes("mujeres") &&
      (indicators.indicatorName.includes("alfabetización") |
        indicators.indicatorName.includes("alfabetizados") ||
        indicators.indicatorName.includes("escolar") |
          indicators.indicatorName.includes("escuela") |
          indicators.indicatorName.includes("instrucción") |
          indicators.indicatorName.includes("Educación") |
          indicators.indicatorName.includes("inscripciones") |
...
function empleo(countryData) {
  ...
  newdataEmpleo = countryData.indicators.filter((indicators) => {
    return (
      indicators.indicatorName.includes("mujeres") &&
      indicators.indicatorName.includes("empleo") |
        indicators.indicatorName.includes("desempleadas") |
        indicators.indicatorName.includes("laboral")
    );
  });
...
function negocios(countryData) {
  ...
  newdataNegocios = countryData.indicators.filter((indicators) => {
    return (
      indicators.indicatorName.includes("mujeres") &&
      indicators.indicatorName.includes("iniciar") |
        indicators.indicatorName.includes("Independientes") |
        indicators.indicatorName.includes("propiedad")
    );
  });
...
function población(countryData) {
  ...
  newdataPoblacion = countryData.indicators.filter((indicators) => {
    return (
      indicators.indicatorName.includes("mujeres") &&
      indicators.indicatorName.includes("población")
    );
  });
...
function salud(countryData) {
  ...
  newdataSalud = countryData.indicators.filter((indicators) => {
    return (
      indicators.indicatorName.includes("mujeres") &&
      (indicators.indicatorName.includes("Prevalencia") |
        indicators.indicatorName.includes("nacer") ||
        indicators.indicatorName.includes("anticoncepción"))
    );
  });
...
function violencia(countryData) {
  ...
  newdataViolencia = countryData.indicators.filter((indicators) => {
    return (
      indicators.indicatorName.includes("mujeres") |
        indicators.indicatorName.includes("Mujeres") &&
      indicators.indicatorName.includes("violencia") |
        indicators.indicatorName.includes("casaron") |
        indicators.indicatorName.includes("golpee")
    );
  });
